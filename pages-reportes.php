							...
							<section class="panel">
								...
								<div class="panel-body">
									<div class="form-group">
										<label class="col-sm-3 control-label">C&eacute;dula de cuidadan&iacute;a propietario:</label>
										<div class="col-sm-3">
											<input type="text" name="cedula" id ="cedula" class="form-control" onKeyPress="return soloNumeros(event)" />
										</div>
										<div class="col-sm-3">

											<input value="Generar Reporte" id="submitPropietario" type="button" class="btn btn-primary"  onclick="generarReporteCedula()" >
										</div>
									</div>
								</div>
							</section>
